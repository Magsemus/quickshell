...
QtObject {
    ...
    property color colDarkBlue: Qt.rgba(0.029, 0.029, 0.194, 0.85)
    property color colDarkerBlue: Qt.rgba(0.009, 0.009, 0.164, 1)
    property color colLightBlue: Qt.rgba(0.049, 0.049, 0.254, 0.5)
